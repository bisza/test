...
int TestGPURayCastCompositeBinaryMask(int argc, char *argv[])
{
 ...
 // char* fname = vtkTestUtilities::ExpandDataFileName(argc, argv, "D:/vtk/VTKData/Data/headsq/quarter");
  ...
  reader->SetFilePrefix( "D:/vtk/VTKData/Data/headsq/quarter" );
 ...
 // delete[] fname;
  ...
  mask->SetScalarType(VTK_UNSIGNED_CHAR);
